    ...
    return(    
      <MDBContainer fluid className=' z-depth-1 mt-5 pt-5 pb-3 px-5' style={{background :'#2bbbad ',zIndex:'-2'}}>
        ...
        { this.state.displayBio ? (<div>
               <p className="white-text"> I live in Istanbul, Turkey , I like coding and my favorite language is JavaScript. I think React is awesome </p>
               <p className="white-text"> beside coding, I like  Reading,waching TV , walking and Eating ice cream </p>
