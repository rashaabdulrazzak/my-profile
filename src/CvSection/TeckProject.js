  ...
  render() {
    return (
      <MDBContainer className="my-3 pt-3 pb-3 px-5">
        <h3 className="font-weight-bold dark-grey-text pb-2">
          Technical Projects{" "}
        </h3>
        <MDBRow>
          {PROJECTS.slice(0, 4).map((pproject) => {
            return (
              <MDBRow>
                <LightSpeed left>
                  <MDBCard className="mb-4" style={{ marginTop: "1rem" }}>
                    <MDBCardBody>
                      ...
                      <MDBCardTitle tag="h6" sub className="mb-2 text-muted">
                        ...
                        <MDBBtn className="default-color">
                          <a href={pproject.github} style={{ color: "white" }}>
                            source code
                          </a>
                        </MDBBtn>
                      </MDBCardTitle>
                      <MDBCardText>{pproject.description}</MDBCardText>
                    </MDBCardBody>
                  </MDBCard>
                </LightSpeed>
              </MDBRow>
